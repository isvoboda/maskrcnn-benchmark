# -*- coding: utf-8 -*-
"""Taken from https://gist.github.com/wangg12/aea194aa6ab6a4de088f14ee193fd968"""
...
parser.add_argument(
    ...
    default=(
        "~/.torch/models/",
        "detectron_35858933_12_2017_baselines_e2e_mask_rcnn_R-50-FPN_1x.yaml.01_48_14.",
        "DzEQe4wC_output_train_coco_2014_train%",
        "3Acoco_2014_valminusminival_generalized_rcnn_model_final.pkl"
    ),
...
newdict['model'] = removekey(_d['model'], remove_keys)
